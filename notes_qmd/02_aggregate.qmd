...
```{python}
eg_file = here() / "bld/2017_11_nepal.nc"
```
...
aggregate_data(cfg, here() / "bld/nepal_2017_11.nc", here() / "data/testing/test_nepal_aggregation.parquet", exposure_variable=variable)
```
