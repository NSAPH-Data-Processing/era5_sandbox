---
description: This is the config module for the pytask pipeline. This module defines
  the data catalog(s) and any hard-coded parameters that are used throughout the pipeline.
output-file: pytask_config.html
title: config
...
[source](https://github.com/TinasheMTapera/era5_sandbox/blob/main/era5_sandbox/config.py#L43){target="_blank" style="float:right; font-size:smaller"}
